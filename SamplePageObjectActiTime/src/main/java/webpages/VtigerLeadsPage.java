...
public class VtigerLeadsPage extends SeleniumUtility{
	...
	@FindBy(xpath ="//button[@id ='Leads_listView_massAction_LBL_DELETE']")
	private WebElement DeleteButtonForLead;
	
	
	@FindBy(xpath ="//button[@class='btn confirm-box-ok confirm-box-btn-pad btn-primary']")
	private WebElement ConfirmDeleteButtonForLead;
	...
	public boolean checkLeadCreation() {
     ...
     public void deleteLead()
     {
    	 ...
    	 clickOnElement(DeleteButtonForLead);
    	 clickOnElement(ConfirmDeleteButtonForLead);
     }
